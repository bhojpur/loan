...
var file_loan_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x6c, 0x6f, 0x61, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31,
	...
	0x53, 0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xa7, 0x04, 0x0a, 0x0b, 0x4c, 0x6f, 0x61, 0x6e, 0x53,
...
var file_loan_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_loan_proto_depIdxs = []int32{
	...
	5,  // 27: v1.LoanService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.LoanService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.LoanService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.LoanService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.LoanService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.LoanService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.LoanService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.LoanService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.LoanService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.LoanService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.LoanService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.LoanService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.LoanService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.LoanService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.LoanService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.LoanService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_loan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_loan_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_loan_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
	...
	file_loan_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_loan_proto_msgTypes[14].OneofWrappers = []interface{}{
